...
declare namespace GQL {
  ...
  interface IQuery {
     ...
     */
    discussionThread: IDiscussionThread | null;
  ...
  interface IDiscussionThreadsOnQueryArguments {
    /**
  ...
  interface IDiscussionThreadOnQueryArguments {
    idWithoutKind: string;
  }

  interface IDiscussionCommentsOnQueryArguments {
    /**
   ...
   */
  type GenericSearchResultInterface =
    | IRepository
    | ICommitSearchResult
    | ICodemodResult;
  ...
  interface ICommentsOnDiscussionThreadArguments {
    /**
     * Returns the first n comments from the list.
     */
    first?: number | null;
  ...
  interface IRelativePathOnDiscussionThreadTargetRepoArguments {
    rev: string;
  }

  interface IRelativeSelectionOnDiscussionThreadTargetRepoArguments {
    rev: string;
  }
   ...
   */
  interface IDiscussionSelectionRange {
  ...
  interface IMutation {
    ...
    /**
     * Manages discussions.
     * @deprecated "discussions will be removed in 3.16. https://github.com/sourcegraph/sourcegraph/issues/9649"
     */
  ...
  interface IUpdateThreadOnDiscussionsMutationArguments {
